/*
  ...
  - The values [AUTO_RECOVERED] on the enum `RecoveryStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "RecoveryStatus_new" AS ENUM ('OPEN', 'AI_PROCESSING', 'PENDING_EXECUTION', 'EXECUTING', 'RECOVERY_ACTION_COMPLETED', 'PENDING_HUMAN_REVIEW', 'BLOCKED', 'FAILED');
